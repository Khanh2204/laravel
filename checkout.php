                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="payment-option">
                                        <ul class=" list-unstyled">
                                            ...
                                            <form class="" method="POST" target="_bank" enctype="application/x-www-form-urlencoded" action="payment_momo.php">
                                                <input type="submit" name="momo" value="Thanh toán MOMO QRcode" class="btn btn_danger">
                                            </form>
                                        </ul>
